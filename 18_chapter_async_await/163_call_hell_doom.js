...
// })
async function run() {
    let responce = await openbrowser();
    console.log(responce);
    let responce1 = await loginpage();
    console.log(responce1);
    let responce2 = await entercrenditals();
    console.log(responce2);
    let responce3 = await clicklogibutton();
    console.log(responce3);
    console.log([responce, responce1, responce2, responce3]);
}
run();